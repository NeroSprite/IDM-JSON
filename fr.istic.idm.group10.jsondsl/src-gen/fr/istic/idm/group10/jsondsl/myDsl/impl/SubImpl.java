...
public class SubImpl extends JSonObjectImpl implements Sub
{
  ...
  public EList<JsonInteger> getListInterger()
  {
    ...
    {
      listInterger = new EObjectResolvingEList<JsonInteger>(JsonInteger.class, this, MyDslPackage.SUB__LIST_INTERGER);
    }
    return listInterger;
  }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == JSonAttribut.class)
    {
      ...
      {
        case MyDslPackage.SUB__NAME: return MyDslPackage.JSON_ATTRIBUT__NAME;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == JSonAttribut.class)
    {
      ...
      {
        case MyDslPackage.JSON_ATTRIBUT__NAME: return MyDslPackage.SUB__NAME;
        default: return -1;
      }
    }
