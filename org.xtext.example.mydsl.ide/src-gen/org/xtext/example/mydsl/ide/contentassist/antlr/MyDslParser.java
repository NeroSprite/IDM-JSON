...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getInsertAccess().getNameObjectAssignment_6(), "rule__Insert__NameObjectAssignment_6");
			builder.put(grammarAccess.getRemoveAccess().getTargetNodeAssignment_3(), "rule__Remove__TargetNodeAssignment_3");
			builder.put(grammarAccess.getRemoveAccess().getNameObjectRemoveAssignment_6(), "rule__Remove__NameObjectRemoveAssignment_6");
			builder.put(grammarAccess.getModifyAccess().getTargetNodeAssignment_3(), "rule__Modify__TargetNodeAssignment_3");
			builder.put(grammarAccess.getModifyAccess().getNameObjectRemoveAssignment_6(), "rule__Modify__NameObjectRemoveAssignment_6");
			builder.put(grammarAccess.getModifyAccess().getNameObjectAssignment_9(), "rule__Modify__NameObjectAssignment_9");
