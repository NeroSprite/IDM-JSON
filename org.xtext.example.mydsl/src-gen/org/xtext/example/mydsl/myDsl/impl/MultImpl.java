 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.MultImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.MultImpl#getListInterger <em>List Interger</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultImpl extends JSonObjectImpl implements Mult
{
  ...
  public EList<JSonOperator> getListInterger()
  {
    ...
    {
      listInterger = new EObjectContainmentEList<JSonOperator>(JSonOperator.class, this, MyDslPackage.MULT__LIST_INTERGER);
    }
    return listInterger;
  }
